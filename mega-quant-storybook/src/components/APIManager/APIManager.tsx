        ...
        <div className="api-modal-body">
          ...
          <div className="api-config-section">
            ...
            <div className="api-input-with-test">
              ...
              >
                {alchemyTest.status === 'testing' && '⏳ Testing...'}
                {alchemyTest.status === 'success' && '✓ Valid'}
                {alchemyTest.status === 'error' && '✕ Invalid'}
          ...
          <div className="api-config-section">
            ...
            <div className="api-input-with-test">
              ...
              >
                {etherscanTest.status === 'testing' && '⏳ Testing...'}
                {etherscanTest.status === 'success' && '✓ Valid'}
                {etherscanTest.status === 'error' && '✕ Invalid'}
          ...
          <div className="api-config-section">
            ...
            <div className="api-input-with-test">
              ...
              >
                {cmcTest.status === 'testing' && '⏳ Testing...'}
                {cmcTest.status === 'success' && '✓ Valid'}
                {cmcTest.status === 'error' && '✕ Invalid'}
