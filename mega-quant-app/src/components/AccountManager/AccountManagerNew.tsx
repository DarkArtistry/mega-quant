  ...
  const handleDeriveAccount = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        console.log(`<IoCheckmarkCircle /> Derived account: ${newDerivedAccountName} at index ${nextIndex}`);
      } else {
  ...
  const handleAddImportedAccount = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        console.log(`<IoCheckmarkCircle /> Added imported account: ${newAccountName}`);
      } else {
        ...
        <div className="modal-content">
          ...
          <div className="form-section">
            ...
            <div style={{
              ...
              >
                <span style={{ marginRight: '0.5rem' }}><IoLeaf /></span>
              ...
              >
                <span style={{ marginRight: '0.5rem' }}><IoKey /></span>
                  ...
                  {generatedMnemonic && (
                    <div style={{
                      ...
                      <div style={{ marginBottom: '1rem', color: '#FFA500', fontWeight: 700 }}>
                        <IoWarning /> IMPORTANT: Save Your Seed Phrase
                      </div>
