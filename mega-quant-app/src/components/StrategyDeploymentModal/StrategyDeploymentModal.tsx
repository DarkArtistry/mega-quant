import { IoWarning, IoLockOpen, IoLockClosed, IoKey, IoEye, IoEyeOff, IoHourglass, IoSettings, IoInformationCircle, IoFlash, IoRocket, IoBarChart, IoWifi, IoCheckmarkCircle, IoClose } from 'react-icons/io5';
    ...
    <div className="modal-overlay" onClick={handleOverlayClick}>
      <div className="strategy-deployment-modal">
        ...
        <div className="modal-header">
          <h2 className="modal-title"><IoFlash /> DEPLOY STRATEGY</h2>
                      ...
                      <div className="config-field">
                        ...
                        {accounts.length === 0 ? (
                          <div className="no-accounts-warning">
                            <span className="warning-icon"><IoWarning /></span>
        ...
        <div className="modal-footer">
          ...
          <button className="deploy-btn" onClick={handleDeploy}>
            <span className="deploy-icon"><IoRocket /></span>
