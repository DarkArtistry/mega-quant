...
import { DeltaTrade, createDeltaTrade } from './trading/index.js'
...
class TradingExecutionManager {
  ...
  async initializeExecution(
    ...
    try {
      ...
      // Create DeltaTrade instance with per-chain private keys
  ...
  /**
   * Close an execution and clean up resources
   */
